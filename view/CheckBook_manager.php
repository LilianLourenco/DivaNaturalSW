    ...
    <body>
        <div class="container"> 
            ...
            <div class="row service">
                <form name="formCheckBook" action="CheckBook_manager.php" method="post" class="margin">
                <div class="col-md-5 menu"></br></br></br>
   <select name="idserv">
                        <option>Select a Customer</option>
                            <?php foreach ($objcustomer->querySelectCustomer() as $rst) { ?>
                    <div class="product">
                        <div class="nome">
                            
                            <option value="<?=$rst['idcustomer'] ?>"><?=$rst['idcustomer'] ?> - <?=$objfc->treatCharacter($rst['name'], 2) ?></option></selct></div>             
 </div>
                <?php } ?>
                    </select></br>
