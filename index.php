<!--  
        REFERENCES
        FranJun, Formulário de cadastro em PHP Orientada a Objeto e PDO com MySQL (CRUD), 2016,
        São Paulo, Escola WWW,
        https://www.youtube.com/watch?v=6HOodAa05ZE&list=PLRwFkczMQf9D4l2D4LY7Uwqf83pzmgdCT&index=1&frags=pl%2Cwn  -->
...
<html lang="en">
            ...
            <nav class="main-menu">
                <div class="row logo1">
                    ...
                    <div class="col-md-6 menu">  
                        <ul>
                            <a href="view/home.php"><li>Home</li> </a>
 
                            <a href="view/blog.php"><li>Blog</li></a> 
                            <a href="view/contact.php"><li>Contact</li> </a>
                            <a href="view/product-form.php" ><li>About us</li> </a>
                        </ul>
                    </div>
  ...
  <path fill-rule="evenodd" d="M13 14s1 0 1-1-1-4-6-4-6 3-6 4 1 1 1 1h10zm-9.995-.944v-.002.002zM3.022 13h9.956a.274.274 0 0 0 .014-.002l.008-.002c-.001-.246-.154-.986-.832-1.664C11.516 10.68 10.289 10 8 10c-2.29 0-3.516.68-4.168 1.332-.678.678-.83 1.418-.832 1.664a1.05 1.05 0 0 0 .022.004zm9.974.056v-.002.002zM8 7a2 2 0 1 0 0-4 2 2 0 0 0 0 4zm3-2a3 3 0 1 1-6 0 3 3 0 0 1 6 0z"/>
                        ...
                        <a href="view/form-subscribe.php"><label class="subs">Subscribe</label></a>
                    </div>       
                </div> 
            </nav>
