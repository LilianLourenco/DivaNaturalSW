...
if(strlen($_POST['nome']))
{
    ...
    {
        echo $_POST['nome']." "."Message success!";
		echo '<br/>';
...
<body>
    ...
    <script type="text/javascript">
        function validaForm()
        {
            ...
            if($('#nome').val() == '')
            {
                alert('Please fill the name );erro = true;
            }
            if($('#email').val() == '' && !erro)
            {
                alert('Please fill the e-mail');erro = true;
            }
            if($('#mensagem').val() == '' && !erro)
            {
                alert('Please fill the message field');erro = true;
            }
